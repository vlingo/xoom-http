...
public class RequestHandler4Test extends RequestHandlerTestBase {
  ...
  public void handlerWithOneParam() {
    ...
    final Response response = handler.execute("my-post", "my-comment", "admin", null).outcome().get();
  ...
  public void errorHandlerInvoked() {
    ...
    Completes<Outcome<ResponseError, Response>> responseCompletes = handler.execute("idVal1", "idVal2", "idVal3", 1);
