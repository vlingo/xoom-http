...
import io.vlingo.xoom.http.resource.TestResponseChannelConsumer;
...
public class FeedResourceTest {
  ...
  public void setUp() throws Exception {
    ...
    properties.setProperty("feed.resource.events.producer.class", "io.vlingo.xoom.http.resource.feed.EventsFeedProducerActor");
