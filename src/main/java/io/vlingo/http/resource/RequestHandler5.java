...
public class RequestHandler5<T, R, U, I, J> extends RequestHandler {
  ...
  public interface Handler5<T, R, U, I, J> {
    Response execute(T param1, R param2, U param3, I param4, J param5);
  }
  ...
  Response execute(final T param1, final R param2, final U param3, final I param4, final J param5) {
  ...
  Response execute(Request request, Action.MappedParameters mappedParameters) {
    ...
    return this.execute(param1, param2, param3, param4, param5);
  }
}
