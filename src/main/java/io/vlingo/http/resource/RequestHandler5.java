...
public class RequestHandler5<T, R, U, I, J> extends RequestHandler<Response> {
  ...
  Completes<Outcome<ResponseError, Response>> execute(final T param1, final R param2, final U param3, final I param4, final J param5) {
