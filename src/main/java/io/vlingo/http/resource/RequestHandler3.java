...
public class RequestHandler3<T, R, U> extends RequestHandler<Response> {
  ...
  Completes<Outcome<ResponseError, Response>> execute(final T param1, final R param2, final U param3) {
