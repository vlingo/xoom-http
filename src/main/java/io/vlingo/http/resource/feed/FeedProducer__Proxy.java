...
public class FeedProducer__Proxy extends ActorProxyBase<io.vlingo.http.resource.feed.FeedProducer> implements io.vlingo.http.resource.feed.FeedProducer {

  private static final String produceFeedForRepresentation1 = "produceFeedFor(io.vlingo.http.resource.feed.FeedProductRequest)";

  private final Actor actor;
  private final Mailbox mailbox;

  public FeedProducer__Proxy(final Actor actor, final Mailbox mailbox){
    super(io.vlingo.http.resource.feed.FeedProducer.class, SerializationProxy.from(actor.definition()), actor.address());
    this.actor = actor;
