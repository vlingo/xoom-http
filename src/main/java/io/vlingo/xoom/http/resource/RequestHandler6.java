...
public class RequestHandler6<T, R, U, I, J, K> extends RequestHandler {
  ...
  public <L> RequestHandler7<T, R, U, I, J, K, L> param(final Class<L> paramClass) {
    return new RequestHandler7<>(method, path, resolverParam1, resolverParam2, resolverParam3, resolverParam4, resolverParam5, resolverParam6,
      ParameterResolver.path(6, paramClass),
      errorHandler,
      mediaTypeMapper);
  }

  public <L> RequestHandler7<T, R, U, I, J, K, L> body(final Class<L> bodyClass) {
    return new RequestHandler7<>(method, path, resolverParam1, resolverParam2, resolverParam3, resolverParam4, resolverParam5, resolverParam6,
  ...
  public RequestHandler7<T, R, U, I, J, K, String> query(final String name) {
    return query(name, String.class);
  }

  public <L> RequestHandler7<T, R, U, I, J, K, L> query(final String name, final Class<L> queryClass) {
    return new RequestHandler7<>(method, path, resolverParam1, resolverParam2, resolverParam3, resolverParam4, resolverParam5, resolverParam6,
  ...
  public RequestHandler7<T, R, U, I, J, K, Header> header(final String name) {
    return new RequestHandler7<>(method, path, resolverParam1, resolverParam2, resolverParam3, resolverParam4, resolverParam5, resolverParam6,
