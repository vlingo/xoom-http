 ...
 * The factory methods will initialize the xoom-wire {@code RefreshableSelector} as
...
public interface Server extends Stoppable {
   ...
   * @param properties the java.util.Properties with properties named per xoom-http.properties
   * @return Server
   */
