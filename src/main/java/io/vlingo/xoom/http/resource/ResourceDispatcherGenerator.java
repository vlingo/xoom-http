...
import static io.vlingo.xoom.common.compiler.DynaFile.GeneratedSources;
...
import static io.vlingo.xoom.common.compiler.DynaNaming.classnameFor;
...
import io.vlingo.xoom.common.compiler.DynaFile;
import io.vlingo.xoom.common.compiler.DynaType;
import io.vlingo.xoom.http.resource.Action.MethodParameter;
import io.vlingo.xoom.http.resource.Action.ToSpec;
...
public class ResourceDispatcherGenerator implements AutoCloseable {
  ...
  private String importStatements(final Class<?> handlerInterface) {
    ...
    builder
      ...
      .append("import io.vlingo.xoom.http.Context;").append("\n")
      .append("import io.vlingo.xoom.http.resource.Action;").append("\n")
      .append("import io.vlingo.xoom.http.resource.Action.MappedParameters;").append("\n")
      .append("import io.vlingo.xoom.http.resource.ConfigurationResource;").append("\n")
      .append("import io.vlingo.xoom.http.resource.ResourceHandler;").append("\n");
